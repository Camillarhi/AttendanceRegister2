        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RulesModelId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    StartOfDayHour = table.Column<int>(type: "integer", nullable: false),
                    StartOfDayMinutes = table.Column<int>(type: "integer", nullable: false),
                    StartOfDayGracePeriod = table.Column<int>(type: "integer", nullable: false),
                    EndOfDayHour = table.Column<int>(type: "integer", nullable: false),
                    EndOfDayMinutes = table.Column<int>(type: "integer", nullable: false),
                    EndOfDayGracePeriod = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
